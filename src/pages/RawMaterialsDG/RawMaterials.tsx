...
const RawMaterials = () => {
  ...
  const tableColumns = [
    ...
    },
    {
      ...
      header: 'Rationale',
      render: (record: SDSRecord) => {
        const truncatedText = record.rationaleSummary.length > 20
          ? `${record.rationaleSummary.substring(0, 20)}...` 
        ...
        return (
          <div 
            ...
            data-tooltip-id={tooltipId}
            data-tooltip-content={record.rationaleSummary.length > 20 ? record.rationaleSummary : ''}
          >
            {truncatedText}
          </div>
        );
  ...
  const stats = useMemo(() => {
    ...
    return [
      { 
        title: 'Total DG Classifications', 
        ...
        <div className="px-6 py-4 border-b border-gray-200">
          <div className="flex flex-col gap-4">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between">
              <div>
                <h2 className="text-lg text-left font-semibold text-gray-900">Raw Materials - DG</h2>
